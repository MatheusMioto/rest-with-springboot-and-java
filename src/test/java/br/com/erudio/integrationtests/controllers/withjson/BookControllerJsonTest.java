...
import br.com.erudio.integrationtests.dto.wrappers.json.WrapperBookDTOV1;
...
class BookControllerJsonTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        // List<BookDTOV1> books = objectMapper.readValue(content, new TypeReference<List<BookDTOV1>>() {});
        WrapperBookDTOV1 wrapper = objectMapper.readValue(content, WrapperBookDTOV1.class);
        var books = wrapper.getEmbedded().getBook();

        BookDTOV1 bookOne = books.get(0);
        ...
        BookDTOV1 foundBookFive = books.get(4);
